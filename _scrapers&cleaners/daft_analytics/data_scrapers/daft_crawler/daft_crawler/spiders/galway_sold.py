...
class GalwaySoldSpider(Spider):
	...
	def parse(self, response):
			...
			for i in range(1,53):												  ## 365 days of sales	
				self.driver.get('https://www.daft.ie/price-register/galway-city/?min_price=25000&max_price=5000000&pagenum={0}'.format(i))
