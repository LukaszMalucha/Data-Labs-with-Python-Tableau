...
class DublinSoldSpider(Spider):
	...
	def parse(self, response):
			...
			for i in range(1,571):												  ## 365 days of sales	
				self.driver.get('https://www.daft.ie/price-register/dublin-city/?min_price=25000&max_price=5000000&pagenum={0}'.format(i))
