...
from core.models import MyProfile, DataSkill
...
class DataSkillModelTests(TestCase):
    ...
    def test_creating_dataskill(self):
        self.assertTrue(self.dataskill)

    def test_dataskill_str(self):
        self.assertEqual(str(self.dataskill), "test skill")
